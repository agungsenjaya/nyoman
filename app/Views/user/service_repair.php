...
<nav class="mb-4 pt-md-3" aria-label="Breadcrumb">
          <ol class="breadcrumb breadcrumb-light">
            ...
            <li class="breadcrumb-item active" aria-current="page">Service Body Repair</li>
          </ol>
        </nav>
<h2 class="text-white">Service Body Repair</h2>
...
<section class="d-flex flex-wrap flex-column flex-sm-row mb-md-3 justify-content-start">
          ...
          <h3 class="icon-box-title text-white fs-sm ps-1 pe-2 mb-0">Body repairing</h3></div>
          <div class="icon-box card flex-row align-items-center flex-shrink-0 card-light py-2 ps-2 pe-4 mb-2 mb-sm-3 me-sm-3 me-xxl-4">
          <div class="icon-box-media bg-faded-primary text-primary rounded-circle me-2"><i class="fi-check-circle"></i></div>
          <h3 class="icon-box-title text-white fs-sm ps-1 pe-2 mb-0">Ketok magic</h3></div>
      </section>
...
<input type="hidden" value="Repair" name="kategori">
...
<div class=" mb-3">
  <label class="form-label fs-xs">Tingkat Kerusakan</label>
...
<div class="mb-3">
<label class="form-label fs-xs" for="">Keterangan Kerusakan</label>
<textarea name="keterangan" class="form-control" id="" cols="30" rows="10" placeholder="Masukan Keterangan Kerusakan" required></textarea>
</div>
<div>
